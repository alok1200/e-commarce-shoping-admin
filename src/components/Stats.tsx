...
const LStats = styled.div<{ color: string }>`
...
const OrderStats = styled.div<{ backColor: string; logoColor: string }>`
  flex: 1;
  height: 100px;
        ...
        <OrdersStatsContainer>
          <OrderStats backColor="FEECDC" logoColor="D03801">
            ...
            <div>
              <p>Total</p>
              <p>
                {orderStats[0].pending +
                  orderStats[0].processing +
                  orderStats[0].delivered}
              </p>
            </div>
          </OrderStats>
